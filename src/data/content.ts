...
export const certifications: CertificationItem[] = [
  ...
  {
    image: "/images/certifications/post brain.png",
  ...
  {
    image: "/images/certifications/post foot.png",
...
export const servicesPageItems: ServicesPageItem[] = [
  {
    ...
    description:
      "Most young athletes train hard — but few train smart. At V Performance, we work with athletes aged 13 to 18 using the same movement principles applied in professional sport, adapted for developing bodies.\n\nEvery young athlete starts with a movement assessment. From there, we build a structured program designed to develop strength, coordination, mobility, and body control — without the risks that come from training that's too intense, too early.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Our personal training program is V Performance's most popular service. You get undivided coaching attention, a program built entirely around your goals, and the kind of accountability that actually produces results.\n\nSessions begin with a full movement and strength assessment. Your coach then designs a structured program combining corrective exercise and progressive strength training, tailored to your current level and target outcomes.",
  ...
  },
  {
    ...
    description:
      "Whether you're returning to fitness after a long break or looking to break through a plateau, our adult fitness programs are built around your goals, your body, and your schedule.\n\nEvery client starts with a movement assessment so we understand where you are before designing where you're going. Programs are built around strength, mobility, and functional movement.",
  ...
  },
  {
    ...
    description:
      "Age is not a limitation. Our oldest active client is 84 years old — proof that with the right approach, movement and strength are available at any stage of life.\n\nOur Senior Fitness program begins with a thorough movement assessment covering mobility, joint health, balance, and individual history. Every session is designed specifically for the individual.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Pain is a signal — not a sentence. Our injury rehabilitation program is built on the principle that lasting recovery requires understanding why an injury happened, not just treating where it hurts.\n\nEvery program begins with a detailed movement assessment to identify the root cause. We build a structured progression that restores mobility, rebuilds strength, and corrects the movement patterns that may have contributed to injury.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Your body goes through profound physical changes during and after pregnancy. Our Pre & Postnatal Fitness program supports you through every stage — safely, effectively, and with full respect for your body's current needs.\n\nDuring pregnancy, training focuses on maintaining strength, improving posture, and supporting the body as it adapts.\n\nAfter birth, the program rebuilds core strength, restores pelvic stability, and progressively returns the body to full movement.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Most people spend hours training, stretching, and planning nutrition — but completely overlook the one thing that fuels all of it. Your breath.\n\nAt V Performance, our Breathwork sessions teach you how to use intentional breathing as a tool to manage stress, improve sleep quality, and accelerate physical recovery. It's one of the most underutilized performance tools available — and it requires nothing but your body.\n\nWhether you're an athlete looking to recover faster between sessions, someone dealing with chronic stress, or simply struggling to get quality sleep — controlled breathing produces real, measurable change.\n\nNo equipment needed. No prior experience required.",
    benefits: [
...
export const galleryImages: GalleryImage[] = [
  { src: "/images/gallery/gallery-1.jpg", wide: true },
  { src: "/images/gallery/gallery-2.jpg" },
  { src: "/images/gallery/gallery-3.jpg" },
  { src: "/images/gallery/gallery-4.jpg" },
  { src: "/images/gallery/gallery-5.jpg" },
  { src: "/images/gallery/gallery-6.jpg", wide: true },
];
